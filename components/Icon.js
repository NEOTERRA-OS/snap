"use client";
// Minimal inline Lucide icons (MIT). No emojis per NEOS guideline.
const P = {
  ...
  train: '<rect width="16" height="16" x="4" y="3" rx="2"/><path d="M4 11h16"/><path d="M12 3v8"/><path d="m8 19-2 3"/><path d="m18 22-2-3"/>',
  ...
  car: '<path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.6-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.5 2.9A3.7 3.7 0 0 0 2 12v4c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><path d="M9 17h6"/><circle cx="17" cy="17" r="2"/>',
...
// `box={false}` renders the bare glyph.
const EXPENSES_D = "M0,48.11c0-6.71,1.26-12.99,3.79-18.83,2.53-5.84,5.97-10.94,10.32-15.29s9.45-7.77,15.29-10.26c5.84-2.49,12.07-3.73,18.71-3.73v48.11H0ZM29.4,96.09c-5.84-2.49-10.94-5.91-15.29-10.26-4.35-4.35-7.79-9.45-10.32-15.29S0,58.42,0,51.71h48.11v48.11c-6.63,0-12.87-1.24-18.71-3.73ZM0,151.78v-48.11h48.11v48.11H0ZM51.84,48.11V0h48.36v48.11h-48.36ZM51.84,99.82v-48.11h48.36v48.11h-48.36ZM51.84,151.78v-48.11h48.36v48.11h-48.36ZM103.55,48.11V0h48.36v48.11h-48.36ZM103.55,99.82v-48.11c6.71,0,12.99,1.26,18.83,3.79,5.84,2.53,10.96,5.97,15.35,10.32,4.39,4.35,7.85,9.45,10.38,15.29s3.79,12.08,3.79,18.71h-48.36ZM148.11,122.38c-2.53,5.84-5.99,10.94-10.38,15.29s-9.51,7.79-15.35,10.32c-5.84,2.53-12.12,3.79-18.83,3.79v-48.11h48.36c0,6.63-1.26,12.87-3.79,18.71Z";
export function Logo({ size = 26, box = true, tile = "#FAD201", glyph = "#2C3C2B" }) {
  if (!box) {
    return (
      <svg width={size} height={size} viewBox="0 0 151.91 151.78" aria-label="NEOS Snap">
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" aria-label="NEOS Snap">
      ...
      <g transform="translate(21.9 21.9) scale(0.37)">
        <path fill={glyph} d={EXPENSES_D} />
      </g>
    </svg>
  );
